...
<html>
  <head>
    ...
    <title>NASA SPACE APP| PASTROLISM</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>PASTORIALSM</b> WEB</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="<?php echo SITEURL; ?>assets/dist/img/admin.jpg" class="user-image" alt="User Image" />
                  <span class="hidden-xs">WEB PASTROLISM</span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo SITEURL; ?>admin/index.php?type=logout" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
